...
public class CapesAPI
{
	...
	private static final String BASE_URL =
		"http://capesapi.com/api/v1/%s/getCape";
	...
	public static void loadCape(final UUID uuid)
	{
		...
		ThreadDownloadImageData threadDownloadImageData =
			new ThreadDownloadImageData(null, url, null, new IImageBuffer()
			{
				@Override
	...
	public static boolean hasCape(UUID uuid)
	{
		...
		if(hasCape && resourceLocation == null
			&& !CapesAPI.hasPendingRequests(uuid))
		{
